...
import com.maria.trip.repository.ApplicationUserRepository;
...
/**
 * REST controller for managing {@link com.maria.trip.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<ApplicationUser> partialUpdateApplicationUser(
        ...
        Optional<ApplicationUser> result = applicationUserRepository
            ...
            .map(existingApplicationUser -> {
                ...
                if (applicationUser.getMobilePhone() != null) {
                    existingApplicationUser.setMobilePhone(applicationUser.getMobilePhone());
                }
